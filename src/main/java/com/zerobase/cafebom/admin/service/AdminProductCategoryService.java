...
public interface AdminProductCategoryService {
    ...
    void modifyProductCategory(Integer id, AdminProductCategoryDto.Request productCategoryDto);
    ...
    AdminProductCategoryDto.Response findByIdProductCategory(Integer id);
}
